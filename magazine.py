...
async def process_screenshot(message: types.Message, state: FSMContext):
    ...
    # Уведомление администраторам в личку
    ...
    for admin_id in ADMIN_IDS:
        try:
            await bot.send_message(admin_id, f"📦 *Новый заказ {order_type} #{order_id}* от {user_display} на {data['product_price']}₽", parse_mode="Markdown")
