...
async def select_stars(c: types.CallbackQuery, state: FSMContext):
    ...
    order_id = await save_stars_order(c.from_user.id, c.from_user.username or "no_username", stars_data["stars"], price, original_price, discount, stars_username)
