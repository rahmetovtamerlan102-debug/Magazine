...
class OrderForm(StatesGroup):
    waiting_for_product_choice = State()   # выбор типа товара
    waiting_for_country = State()          # выбор страны (номера)
    waiting_for_stars = State()            # выбор кол-ва звёзд
