...
WEBHOOK_URL = f"https://{os.getenv('RENDER_EXTERNAL_HOSTNAME')}{WEBHOOK_PATH}" if os.getenv("RENDER_EXTERNAL_HOSTNAME") else f"http://localhost:{PORT}{WEBHOOK_PATH}"
